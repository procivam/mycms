					...
					<div class="box box-success">
						...
						<div class="box-body">
		                    ...
		                    <div class="form-group">
		                      ...
		                      <input type="text" name="name" value="{{ isset($obj) ? $obj->name : "" }}" class="form-control" id="slugify_source" placeholder="Название новости" minlength="1" maxlength="255" required/>
		                    </div>
		                    <div class="form-group">
		                      <label>Алиас</label>
		                      <input type="text" name="alias" value="{{ isset($obj) ? $obj->alias : "" }}" class="form-control" id="slugify_target" placeholder="Алиас новости" minlength="1" maxlength="255" required/>
		                    </div>
		                    <div class="form-group">
			                    <label>Дата публикации</label>
			                    <div class='input-group date' id='datetimepicker'>
	                      			<input type="text" name="published_at" value="{{ isset($obj) ? $obj->published_at : "" }}" class="form-control" placeholder="Дата публикации" minlength="16" maxlength="16" required/>
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<div class="form-group">
		                        ...
		                        <input type="text" name="title" value="{{ isset($obj) ? $obj->title : "" }}" class="form-control" placeholder="Заголовок новости" minlength="1" maxlength="255" required/>
		                    </div>
		                    <div class="form-group">
		                        <label>Keywords (Ключевые слова)</label>
		                        <input type="text" name="keywords" value="{{ isset($obj) ? $obj->keywords : "" }}" class="form-control taginput" placeholder="Ключевые слова для новости"/>
		                    </div>
							<div class="form-group">
		                        <label>Description (Описание)</label>
			                    <textarea name="description" value="{{ isset($obj) ? $obj->description : "" }}" class="form-control" rows="7" placeholder="Описание новости"></textarea>
		                    </div>
						</div><!-- /.box-body -->
					</div><!-- /.box -->
				</div>
