...
return [
    ...
    */
    ...
    'min'                  => [
        'numeric' => 'Параметр :attribute должен быть меньше :min.',
        'file'    => 'Параметр :attribute должен быть меньше :min килобайт.',
        'string'  => 'Параметр :attribute должен быть меньше :min символов.',
        'array'   => 'Параметр :attribute must have меньше :min элементов.',
    ],
